...
const FormField = (props: FormFieldProps) => {
  const [local, others] = splitProps(props as FormFieldProps, [
    "label",
    "placeholder",
    "type",
    "value",
  ...
  return (
    <TextField class={cn("grid gap-2", local.class)}>
      ...
      {local.error && (
        <TextFieldDescription class="text-red-500">
          {local.error}
